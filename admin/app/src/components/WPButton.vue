  ...
  <button v-if="props.as === 'button'" :class="computedClasses">
    <div class="tw-flex tw-justify-center tw-items-center tw-h-full">
      ...
      <template v-if="props.loading">
          <svg aria-hidden="true" class="button_loader tw-absolute tw-w-4 tw-h-4 tw-text-gray-100 tw-animate-spin tw-fill-primary-500" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
